...
int main(int argc, char** argv) {
    ...
    AudioFile<double> audio_out_compressed = compress(audioFile_out);
    audio_out_compressed.save(file_out_compressed);
    AudioFile<double> audio_out_decompressed = decompress(audio_out_compressed);
    audio_out_decompressed.save(file_out_decompressed);
